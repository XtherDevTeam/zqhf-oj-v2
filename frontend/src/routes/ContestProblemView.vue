  ...
  <div>
    <el-card shadow="hover" class="box-card">
      <div slot="header" class="clearfix">
        ...
        <el-button style="float: right; padding: 3px 0" type="text" @click="back_to_contest()">返回比赛界面</el-button>
      </div>
...
export default {
  methods: {
    ...
    init() {
      ...
      axios.get('/api/v1/contests/' + this.$route.query['contest'] + '/problems/get/' + this.$route.query['t']).then((response) => {
